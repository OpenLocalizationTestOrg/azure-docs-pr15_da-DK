<properties
pageTitle="Tilføje Excel forbindelsen | Microsoft Azure"
description="Oversigt over Excel-forbindelse med REST-API parametre"
services=""    
documentationCenter=""     
authors="msftman"    
manager="erikre"    
...
# <a name="get-started-with-the-excel-connector"></a>Introduktion til Excel-forbindelse

I øjeblikket, er der ingen Excel forbindelse i logik Apps. 

## <a name="to-use-excel-data"></a>Bruge Excel-data
Du kan gemme Excel-data som en fil med semikolonseparerede værdier (CSV)-fil i en mappe skal gemmes, såsom [OneDrive](connectors-create-api-onedrive.md). Du kan også bruge denne csv-fil med [flad fil forbindelse](../app-service-logic/app-service-logic-enterprise-integration-flatfile.md).
