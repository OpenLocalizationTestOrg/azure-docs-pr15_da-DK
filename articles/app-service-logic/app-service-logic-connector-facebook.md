<properties
   pageTitle="Brug af Facebook-forbindelse i logik Apps | Microsoft Azure App Service"
   description="Hvordan du kan oprette og konfigurere appen Facebook-forbindelse eller API og bruge det i en logik app i Azure App Service"
   services="logic-apps"
...
# <a name="weve-improved-the-facebook-connector"></a>Vi har forbedret Facebook-forbindelse 
...
- [Lær mere om denne nye forbindelse](../connectors/connectors-create-api-facebook.md)
