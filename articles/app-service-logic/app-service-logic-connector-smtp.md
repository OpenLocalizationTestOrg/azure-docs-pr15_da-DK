<properties
   pageTitle="Ved hjælp af SMTP Connector i logik Apps | Microsoft Azure App Service"
   description="Hvordan du kan oprette og konfigurere app'en SMTP-forbindelse eller API og bruge det i en logik app i Azure App Service"
   services="logic-apps"
...
# <a name="weve-improved-the-smtp-connector"></a>Vi har forbedret SMTP-forbindelse 
...
- [Lær mere om denne nye forbindelse](../connectors/connectors-create-api-smtp.md)
