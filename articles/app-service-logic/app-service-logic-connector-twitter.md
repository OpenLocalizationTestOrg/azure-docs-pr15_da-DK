<properties
   pageTitle="Ved hjælp af Twitter Connector i logik Apps | Microsoft Azure App Service"
   description="Hvordan du kan oprette og konfigurere app'en Twitter-forbindelse eller API og bruge det i en logik app i Azure App Service"
   services="logic-apps"
...
# <a name="weve-improved-the-twitter-connector"></a>Vi har forbedret Twitter-forbindelse 
...
- [Lær mere om denne nye forbindelse](../connectors/connectors-create-api-twitter.md)
