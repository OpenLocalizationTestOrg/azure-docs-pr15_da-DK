<properties
    pageTitle="Maskine læ algoritme snyde ark | Microsoft Azure"
    description="En udskriftsvenlig maskine læ algoritme snyde ark hjælper dig med at vælge den rigtige algoritme for din skønnet i Azure maskine læ Studio."
    keywords="algoritme snyde ark snyde ark machine learning algoritme"
...
# <a name="machine-learning-algorithm-cheat-sheet-for-microsoft-azure-machine-learning-studio"></a>Machine learning algoritme snyde ark til Microsoft Azure maskine læ Studio

**Microsoft Azure Machine Learning algoritme Cheat ark** hjælper dig med at vælge den rigtige algoritme for en skønnet analytics-model.

[Azure Machine Learning Studio](https://studio.azureml.net/) har et stort bibliotek med algoritmer fra den ***simple lineære regression***, ***klassifikation***, ***klynge***og ***anomali registrering*** familier. Hver er udviklet til at løse en anden type machine learning problem.


## <a name="download-machine-learning-algorithm-cheat-sheet"></a>Download: Machine learning algoritme snyde ark

**Hente arket snyde her: [Machine Learning algoritme Cheat ark (11 x 17 in.)](http://download.microsoft.com/download/A/6/1/A613E11E-8F9C-424A-B99D-65344785C288/microsoft-machine-learning-algorithm-cheat-sheet-v6.pdf)**

![Machine Learning algoritme snyde ark: Lær, hvordan du vælger en Machine Learning algoritme.][cheat-sheet]

[cheat-sheet]: ./media/machine-learning-algorithm-cheat-sheet/machine-learning-algorithm-cheat-sheet-small_v_0_6-01.png

Downloade og udskrive Machine Learning algoritme Cheat arket i tabloid størrelse for at beholde den praktiske og få hjælp til at vælge en algoritme.

> [AZURE.NOTE] Du kan finde en detaljeret vejledning til brug af dette snyde ark i artiklen [Sådan vælger du algoritmer til Microsoft Azure Machine Learning](machine-learning-algorithm-choice.md) .

## <a name="more-help-with-algorithms"></a>Få mere hjælp til algoritmer

* Se, [hvordan du algoritmer til Microsoft Azure computer kan du vælge](machine-learning-algorithm-choice.md)en dybere beskrivelse af de forskellige typer machine learning algoritmer, hvordan de bruges, og hvordan du bruger denne snyde ark for at vælge den rigtige algoritme.
