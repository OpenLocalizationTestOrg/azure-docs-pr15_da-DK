<properties 
    pageTitle="Hvordan du opretter ved hjælp af Media Encoder Standard med .NET miniaturer" 
    description="Dette emne viser, hvordan du bruger .NET at kode et aktiv og generere miniaturer ad gangen ved hjælp af Media Encoder Strandard." 
...
#<a name="how-to-generate-thumbnails-using-media-encoder-standard-with-net"></a>Hvordan du opretter ved hjælp af Media Encoder Standard med .NET miniaturer

Dette emne viser, hvordan du bruger Media Services .NET SDK at kode et aktiv og generere miniaturer ved hjælp af Media Encoder Standard. Emnet definerer de XML- og JSON miniature forudindstillinger, som du kan bruge til at oprette en opgave, der indeholder kode og genererer miniaturer på samme tid. [Dette](https://msdn.microsoft.com/library/mt269962.aspx) dokument indeholder beskrivelser af elementer, der anvendes af forudindstillingerne.

Sørg for at læse afsnittet [overvejelser i forbindelse med](media-services-dotnet-generate-thumbnail-with-mes.md#considerations) .
...
- Indlæse forudindstillede [XML](media-services-dotnet-generate-thumbnail-with-mes.md#xml) eller [JSON](media-services-dotnet-generate-thumbnail-with-mes.md#json) , der indeholder den kodning forudindstillet samt oplysninger, der bruges til at generere miniaturer. Du kan gemme denne [XML](media-services-dotnet-generate-thumbnail-with-mes.md#xml) eller [JSON](media-services-dotnet-generate-thumbnail-with-mes.md#json) i en fil og bruge følgende kode til at indlæse filen.
...
##<a id="json"></a>Miniature JSON forudindstillet
...
##<a id="xml"></a>Miniature XML-format
