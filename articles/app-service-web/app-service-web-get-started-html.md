...
Dette selvstudium hjælper dig med at installere en simpel HTML + CSS WebApp til [Azure App-tjenesten](../app-service/app-service-value-prop-what-is.md).
...
- Installer HTML og CSS til den.
- Se dine sider, der kører direkte i fremstilling.
- Opdater dit indhold på samme måde, du ville gøre [opslagsnål ciffer bekræfter](https://git-scm.com/docs/git-push).
...
## <a name="deploy-a-simple-html-site"></a>Installere en enkelt HTML-websted
