<properties 
   pageTitle="Installere en VM med en statiske offentlige IP-Adresser ved hjælp af Azure CLI i ressourcestyring | Microsoft Azure"
   description="Lær, hvordan du installerer FOS med en statiske offentlige IP-Adresser ved hjælp af Azure CLI i ressourcestyring."
...
# <a name="deploy-a-vm-with-a-static-public-ip-using-the-azure-cli"></a>Installere en VM med en statiske offentlige IP-Adresser ved hjælp af Azure CLI
...
Du kan hente den fulde fest script, der bruges [her](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/IaaS-Story/03-Static-public-IP/virtual-network-deploy-static-pip-arm-cli.sh). Følg nedenstående trin for at ændre scriptet til at arbejde i dit miljø.
...
4. Oprette netværksgrænsefladen (NIC) for VM i den oprettede ovenfor, med den offentlige IP-undernet. Meddelelse om det første sæt kommandoer bruges til at hente **Id** for det undernet, der er oprettet ovenfor.
...
1. Fra en fest console skal du køre scriptet ovenfor.
