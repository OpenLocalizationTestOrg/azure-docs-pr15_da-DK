<properties
   pageTitle="Oprette Windows-baseret Hadoop klynger i HDInsight ved hjælp af .NET SDK | Microsoft Azure"
    description="Lær at oprette HDInsight klynger til Azure HDInsight ved hjælp af .NET SDK."
   services="hdinsight"
   documentationCenter=""
   tags="azure-portal"
   authors="mumian"
...
# <a name="create-windows-based-hadoop-clusters-in-hdinsight-using-net-sdk"></a>Oprette Windows-baseret Hadoop klynger i HDInsight ved hjælp af .NET SDK

[AZURE.INCLUDE [selector](../../includes/hdinsight-selector-create-clusters.md)]


Lær at oprette HDInsight klynger ved hjælp af .NET SDK. Andre klynge oprettelse af værktøjer og funktioner, klik på fanen Vælg øverst på denne side eller se [metoder til oprettelse af klynge](hdinsight-provision-clusters.md#cluster-creation-methods).
...
HDInsight .NET SDK indeholder .NET klientbiblioteker, der gør det nemmere at arbejde med HDInsight fra et .NET Framework-program. Følg vejledningen nedenfor for at oprette et Visual Studio console-program, og Indsæt koden til oprettelse af en klynge.

Programmet kræver en Azure ressourcegruppe og lagerplads standardkontoen.  [Tillæg A](#appx-a-create-dependent-components) indeholder et PowerShell-script for at oprette de afhængige komponenter.

**Sådan oprettes et Visual Studio console-program**

1. Oprette et nyt C# console-program i Visual Studio.
2. Køre følgende kommando for Nuget i Nuget pakke Management console.
...
7. Tryk på **F5** for at køre programmet. Et console vindue skal åbnes og viser status for programmet. Du kan også bedt om at angive dine legitimationsoplysninger Azure-konto. Det kan tage flere minutter at oprette en HDInsight klynge.
...
##<a name="appx-a-create-dependent-components"></a>Appx-A Opret afhængige komponenter

Den følgende Azure PowerShell script kan være bruge til at oprette de afhængige komponenter, der er nødvendige for .NET-program i dette selvstudium.
