...
# <a name="run-sqoop-jobs-using-azure-powershell-for-hadoop-in-hdinsight"></a>Køre Sqoop job med Azure PowerShell til Hadoop i HDInsight

[AZURE.INCLUDE [sqoop-selector](../../includes/hdinsight-selector-use-sqoop.md)]

Lær at bruge Azure PowerShell til at køre Sqoop job i HDInsight til at importere og eksportere mellem HDInsight klynge og Azure SQL-database eller SQL Server-database.

> [AZURE.NOTE] Trinnene i denne artikel kan bruges med enten en Windows-baseret eller Linux-baserede HDInsight klynge; disse trin fungerer kun fra en Windows-klient. Klik på tabulatorvælgeren øverst i artiklen til andre job bidrag metoder.
...
## <a name="run-sqoop-using-powershell"></a>Køre Sqoop ved hjælp af PowerShell

Følgende PowerShell-script allerede behandler kildefilen, og eksporterer til en Azure SQL-database:
