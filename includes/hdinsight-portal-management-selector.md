> [AZURE.SELECTOR]
- [Portal (Linux klynge)](../articles/hdinsight/hdinsight-administer-use-portal-linux.md)
- [Portal (Windows-klynge)](../articles/hdinsight/hdinsight-administer-use-management-portal.md)
